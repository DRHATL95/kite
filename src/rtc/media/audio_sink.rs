...
mod cpal_sink {
    ...
    impl AudioSink {
        ...
        pub fn new() -> Result<Self> {
            ...
            // cpal 0.18 turned SampleRate from a newtype into a plain alias, so
            // the rate is written bare rather than wrapped.
            ...
            let stream = device
                // 0.18 takes the config by value; nothing reads it afterwards.
                .build_output_stream(
                    config,
